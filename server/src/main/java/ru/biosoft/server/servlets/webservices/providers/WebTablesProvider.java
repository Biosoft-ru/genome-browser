...
//import ru.biosoft.table.document.editors.TableElementBeanInfo.ExpressionEditor;
...
public class WebTablesProvider extends WebProviderSupport
{
    ...
    public static class TableQueryResponse
    {
        ...
        private void applyFilter()
        {
            ...
            //TODO: commented, RowFilter (JavaScript related part not moved)
            //            if( filterStr != null )
            //            {
    ...
    {
        //TODO: commented RowFilter, JAVASCript related code not moved
        //        try
        //        {
        ...
        else if( ( value instanceof DataElementPath || value instanceof DataElementPathSet ) && readOnly )
        {
            ...
            for( DataElementPath dep : paths )
            {
                ...
                sb.append("showDataElementLink('viewer_" + uid + "', '" + StringEscapeUtils.escapeEcmaScript(dep.toString()) + "','"
                        + (iconId == null ? "" : StringEscapeUtils.escapeEcmaScript(iconId)) + "','" + StringEscapeUtils.escapeEcmaScript(title) + "', " + dep.exists() + ");");
            }
    ...
    public static void sendTableColumns(DataCollection<?> dc, JSONResponse response) throws IOException
    {
        ...
        for( Column column : columnModel.getColumns() )
        {
            ...
            try
            {
                ...
                columnEntry.put("jsName", TextUtil2.getValidName(column.getName()));
    ...
    public static class SqlQueryTableResolver extends TableResolver
    {
        ...
        public DataCollection<?> getTable(DataElement de) throws Exception
        {
            ...
            //TODO: commented, JournalRegistry
    ...
    public static void addTableResolver(String name, String className)
    {
        resolverRegistry.addElement(name, className);
    }
}
