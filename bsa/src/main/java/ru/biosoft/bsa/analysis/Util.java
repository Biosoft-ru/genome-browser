...
public class Util
{
 ...
 // new version
    ...
    //TODO: code changed, avoid ArrayUtils.toMap
    //    public static final Map<String, Integer> logBaseNameToCode = ArrayUtils.toMap(new Object[][] { {"non-logarithmic", NONE}, {"log2", LOG2},
    //            {"log10", LOG10}, {"logE", LN}});

    public static final Map<String, Integer> logBaseNameToCode;
    static
    {
        Map<String, Integer> tmpMap = new HashMap<>();
        tmpMap.put("non-logarithmic", NONE);
        tmpMap.put("log2", LOG2);
        tmpMap.put("log10", LOG10);
        tmpMap.put("logE", LN);
        logBaseNameToCode = Collections.unmodifiableMap(tmpMap);
    }
