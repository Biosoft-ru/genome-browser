            ...
            FunctionJobControl jobControl, Logger log) throws Exception
    {
        ...
        try
        {
            ...
            if(typeSpecificCollection instanceof Repository)
            {
                ...
                track = (BigBedTrack)DataCollectionUtils.fetchPrimaryCollection(parentRepository.createDataCollection(name, trackProperties, null, null, null), Permission.WRITE);
            }
            else
            {
                ...
                track = new BigBedTrack( parent, trackProperties, false );
            }
